...

{
    ...
    // If requestFileId1 and requestFileId2 exist in ai_scan_jobs reftab

    let lstJobsExist = db.ai_scan_jobs.ReadFields({id: [stJobId,stJobId2]},["delivery_note_id"]);

    if(lstJobsExist.Count() == 0)
    {
        // Set default user if exist in ai_scan_settings reftab
    ...
    {
        Log("Annotation jobs exist in DM company!");
    }
}